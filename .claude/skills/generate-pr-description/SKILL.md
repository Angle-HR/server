...
description: Use when the user asks for a PR description, pull request body, GitHub PR text for the active branch, or when preparing to open a PR. Drafts a pull request description for the active Git branch using the repository PR template.
---
