...
const (
	...
	MsgInvalidSubmissionID                    = "invalid submission id"
	MsgSubmissionNotFound                     = "submission not found"
	MsgNoteAndCreatedByRequired               = "note and created_by are required"
	...
	MsgInvalidSubmittedFrom                   = "invalid submitted_from"
	MsgInvalidSubmittedTo                     = "invalid submitted_to"
	...
	MsgAdminScopeRequired                     = "admin scope required"
)
